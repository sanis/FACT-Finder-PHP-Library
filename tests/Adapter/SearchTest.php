...
class SearchTest extends \FACTFinder\Test\BaseTestCase
{
    ...
    public function testGetAfterSearchNavigation()
    {
        ...
        $this->assertEquals('/index.php?seoPath=%2Fbmx%2Fq&filterCategory2=BMX&filterCategory1=Fahrr%C3%A4der&followSearch=9798&filterRatingAverage=', $slider->getBaseUrl());
        $this->assertEquals('/index.php?seoPath=%2Fbmx%2Fq&filterCategory2=BMX&filterCategory1=Fahrr%C3%A4der&followSearch=9798&filterRatingAverage=4-5', $slider->getUrl());
